...
SUSTN collects anonymous usage analytics to help improve the product. This feature is **opt-in** and can be disabled at any time in Settings → General → "Share anonymous usage data".
